...
features <- gene_list[["FGFR4"]]
overlaps$Gene <- names(gene_list)[overlaps$subjectHits]

sample.gr <- variant_granges[unlist(subset(overlaps, Gene == "FGFR4", select = queryHits))]
...
lollipopplot met gefilterd en niet gefilterd, maar gefilterd highlighten
